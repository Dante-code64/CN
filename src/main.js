...
import { initGame_2048, renderGame_2048, g2048Spawn, g2048Slide, g2048Move } from './games/2048.js';
...
import { renderShop, buyItem, buyQuick, sellItem } from './economy/shop.js';
...
// ── NOTIFICATIONS ──────────────────────────
export function notify(type, msg, duration = 3500) {
...
export function gameReward(cry, xp) {
  G.wallet += (cry || 0);
